...
public class BigNumArithmetic {
     ...
     */
    public static LinkedList<Integer> exponentiation(
        LinkedList<Integer> LL2,
        LinkedList<Integer> LL1) {
        LinkedList<Integer> LL3 = new LinkedList<Integer>();
        ...
        if (bSize == 1 && LL2.get(bSize - 1).getData() == 1) { // if n is 1,
                                                               // return x
            return LL1;
        }

        if (bSize == 1 && LL2.get(bSize - 1).getData() == 0) { // if n is 0,
                                                               // return 1
            LL3.push(1);
            return LL3;
        }
    ...
    public static LinkedList<Integer> multiplication(
        LinkedList<Integer> LL1,
        LinkedList<Integer> LL2) {
        ...
        if ((aSize == 1 && LL2.get(0).getData() == 0) || (bSize == 1 && LL2.get(
            0).getData() == 0)) {
